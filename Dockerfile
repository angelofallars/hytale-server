...
# Currently this requires going through a browser auth flow, and there's no way around it.
RUN ./hytale-downloader-linux-amd64 -print-version \
    # Put Hytale version into a file to unzip the downloaded file later
