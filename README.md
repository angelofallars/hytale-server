...
- `mods.txt` - The list of mods installed in the server, from CurseForge.
               The mod URLs are sourced by downloading a mod from CurseForge and then copying the URL of the file to download through browser inspect element
               (like `https://mediafilez.forgecdn.net/files/7491/939/EyeSpy-2026.1.20-5708.jar`).
